<?php
// Created with ./artisan command:make IndexPosts --command=post:index
// Registered from app/start/artisan.php 
...
class IndexPosts extends Command {
	 ...
	 * @var string
	 */
	protected $description = 'Index all un-indexed mrcore posts.';
